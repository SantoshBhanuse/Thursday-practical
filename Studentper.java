public class Studentper
{
	public static void main(String[] args) 
	{
		...
		System.out.println("Student 1 Per: " +obj.getPercentage());
		B it = new B(60f , 70f , 80f , 90f);
		System.out.println("Student 2 Per: " +it.getPercentage());
	}   
}
abstract class Obtained
{
	abstract float getPercentage();
}
	class A extends Obtained
	{
